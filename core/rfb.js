...
const NovncPlugin = {
  install: function (Vue, options) {
    ...
    function RFB(target, url, options) {
      ...
      this._scaleViewport = options.scaleViewport;
      this._viewOnly = options.viewOnly;
      this._focusOnClick = options.focusOnClick;
      this._touchButton = options.touchButton;
      this._clipViewport = options.clipViewport;
      this._dragViewport = options.dragViewport;
      this._resizeSession = options.resizeSession;
      ...
      this._screen.style.backgroundColor = this._background || 'rgb(40, 40, 40)';
